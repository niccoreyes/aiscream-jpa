...
**Date:** 2026-06-17T18:14:57.093386
**Server:** https://fhirportal.telehealth.ph/eref/fhir
**Patient identifier:** `BT-PATIENT-20260617-181457`
  ...
  "identifier": [
    {
      ...
      "value": "NOPROFILE-NEGATIVE-20260617-181457"
    }
  ],
  "name": [
    {
...
```json
{
  ...
  "identifier": [
    {
      "system": "https://fhir.doh.gov.ph/identifier/philhealth-id",
      "value": "EMPTYPROFILE-NEGATIVE-20260617-181457"
    }
  ],
  "name": [
    {
...
```json
{
  ...
  "entry": [
    {
      "fullUrl": "urn:uuid:mixed-no-profile-20260617-181457",
      "resource": {
        "resourceType": "Patient",
        "identifier": [
          {
    ...
    {
      "fullUrl": "urn:uuid:mixed-obs-1-20260617-181457",
      "resource": {
        ...
        "subject": {
          "reference": "urn:uuid:mixed-no-profile-20260617-181457"
        },
    ...
    {
      "fullUrl": "urn:uuid:mixed-obs-2-20260617-181457",
      "resource": {
        "resourceType": "Observation",
        "meta": {
          "profile": [
...
### Rollback check /Patient?identifier=https://fhir.doh.gov.ph/identifier/philhealth-id|NOPROFILE-NEGATIVE-20260617-181457
...
```json
{
  ...
  "identifier": [
    {
      "system": "https://fhir.doh.gov.ph/identifier/philhealth-id",
      "value": "INVALIDPROFILE-NEGATIVE-20260617-181457"
    }
  ],
  "name": [
    {
  ...
  "identifier": [
    {
      ...
      "value": "CANONICAL-PHCORE-20260617-181457"
    }
  ],
  "name": [
    {
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2026-06-17T10:15:00.335+00:00",
    "profile": [
      "https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-patient"
    ]
  },
...
- **[PASS]** PH Core canonical Patient accepted (HTTP 201) -> `16421`
---
...
```json
{
  ...
  "identifier": [
    {
      "system": "https://fhir.doh.gov.ph/identifier/philhealth-id",
      "value": "CANONICAL-EREF-20260617-181457"
    },
    {
      "system": "https://fhir.doh.gov.ph/identifier/philsys",
      "value": "6789-1234-20260617-181457"
    }
  ],
  "name": [
    {
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2026-06-17T10:15:01.758+00:00",
    "profile": [
      "https://fhir.doh.gov.ph/pheref/StructureDefinition/ereferral-patient"
    ]
  },
...
- **[PASS]** eReferral canonical Patient accepted (HTTP 201) -> `16422`
---
...
```json
{
  ...
  "entry": [
    {
      "fullUrl": "urn:uuid:canonical-patient-20260617-181457",
      "resource": {
        "resourceType": "Patient",
        "meta": {
          "profile": [
        ...
        "identifier": [
          {
            "system": "https://fhir.doh.gov.ph/identifier/philhealth-id",
            "value": "CANONICAL-BUNDLE-20260617-181457"
          }
        ],
        "name": [
          {
    ...
    {
      "fullUrl": "urn:uuid:canonical-obs-1-20260617-181457",
      "resource": {
        "resourceType": "Observation",
        "meta": {
          "profile": [
        ...
        "subject": {
          "reference": "urn:uuid:canonical-patient-20260617-181457"
        },
        "effectiveDateTime": "2026-06-17T10:00:00+08:00",
        "component": [
          {
    ...
    {
      "fullUrl": "urn:uuid:canonical-obs-2-20260617-181457",
      "resource": {
        "resourceType": "Observation",
        "meta": {
          "profile": [
...
{
  "resourceType": "Bundle",
  "id": "eb321f9c-e1f3-4641-a8aa-c1c8dcb72816",
  ...
  "entry": [
    {
      "response": {
        "status": "201 Created",
        "location": "Patient/16423/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:02.780+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Patient/16423/_history/1&quot;. Took 24ms.</td></tr></table></div>"
          },
          "issue": [
            {
              ...
              "diagnostics": "Successfully created resource \"Patient/16423/_history/1\". Took 24ms."
            }
          ]
        }
      }
    },
    {
      "response": {
        "status": "201 Created",
        "location": "Observation/16424/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:02.780+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Observation/16424/_history/1&quot;. Took 6ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Observation/16424/_history/1\". Took 6ms."
            }
          ]
        }
      }
    },
    {
      "response": {
        "status": "201 Created",
        "location": "Observation/16425/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:02.780+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Observation/16425/_history/1&quot;. Took 1ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Observation/16425/_history/1\". Took 1ms."
            }
          ]
        }
      }
...
```json
{
  ...
  "identifier": [
    {
      "system": "https://fhir.doh.gov.ph/identifier/philhealth-id",
      "value": "BT-PATIENT-20260617-181457"
    }
  ],
  "name": [
    {
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2026-06-17T10:15:03.014+00:00",
    "profile": [
      "https://fhir.doh.gov.ph/pheref/StructureDefinition/ereferral-patient"
    ]
  },
...
**Extracted Patient ID:** `16426`
- **[PASS]** Patient created (HTTP 201) → `16426`
---
## 2. POST Transaction Bundle (BP + Hemoglobin)

POST a `Bundle` of type `transaction` with two Observations — Blood Pressure panel and Hemoglobin — referencing `16426`.
### POST / (Bundle) 
...
{
  "resourceType": "Bundle",
  "id": "41c3b430-90e3-4eeb-8efe-7bd047c3e136",
  "type": "transaction-response",
  "link": [
    {
      "relation": "self",
  ...
  "entry": [
    {
      "response": {
        "status": "201 Created",
        "location": "Observation/16427/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:03.249+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Observation/16427/_history/1&quot;. Took 2ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Observation/16427/_history/1\". Took 2ms."
            }
          ]
        }
      }
    },
    {
      "response": {
        "status": "201 Created",
        "location": "Observation/16428/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:03.249+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Observation/16428/_history/1&quot;. Took 2ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Observation/16428/_history/1\". Took 2ms."
            }
          ]
        }
      }
...
### GET /Observation?subject=Patient/16426
...
{
  "resourceType": "Bundle",
  "id": "13a0c6a7-843f-4842-866f-5523fba9c5d5",
  "meta": {
    "lastUpdated": "2026-06-17T10:15:03.481+00:00"
  },
  "type": "searchset",
  "total": 2,
  "link": [
    {
      "relation": "self",
      "url": "http://fhirportal.telehealth.ph/fhir/Observation?subject=Patient%2F16426"
    }
  ],
  "entry": [
    {
      "fullUrl": "http://fhirportal.telehealth.ph/fhir/Observation/16427",
      "resource": {
        "resourceType": "Observation",
        "id": "16427",
        "meta": {
          "versionId": "1",
          "lastUpdated": "2026-06-17T10:15:03.249+00:00",
          "profile": [
            "https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-observation"
          ]
        },
    ...
    {
      "fullUrl": "http://fhirportal.telehealth.ph/fhir/Observation/16428",
      "resource": {
        "resourceType": "Observation",
        "id": "16428",
        "meta": {
...
1. A Patient with the **same PhilHealth identifier** as the already-created Patient `16426` (name: InBundleDuplicate, gender: other)
...
{
  "resourceType": "Bundle",
  "id": "5f6ba2d6-cb6b-4be6-9c42-c71d800b36dc",
  "type": "transaction-response",
  "link": [
    {
      "relation": "self",
  ...
  "entry": [
    {
      "response": {
        "status": "201 Created",
        "location": "Patient/16429/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:03.759+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Patient/16429/_history/1&quot;. Took 287ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Patient/16429/_history/1\". Took 287ms."
            }
          ]
        }
      }
    },
    {
      "response": {
        "status": "201 Created",
        "location": "Observation/16430/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:03.759+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Observation/16430/_history/1&quot;. Took 1ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Observation/16430/_history/1\". Took 1ms."
            }
          ]
        }
      }
    },
    {
      "response": {
        "status": "201 Created",
        "location": "Observation/16431/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:03.759+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Observation/16431/_history/1&quot;. Took 0ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Observation/16431/_history/1\". Took 0ms."
            }
          ]
        }
      }
...
Search for all Patients with the PhilHealth identifier `BT-PATIENT-20260617-181457`. Transaction dedup should have converted the Patient entry from POST to PUT, so only **1 Patient** exists:

- `16426` (the original, updated with merged fields from step 4)
### GET /Patient?identifier=https://fhir.doh.gov.ph/identifier/philhealth-id|BT-PATIENT-20260617-181457
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2026-06-17T10:15:04.464+00:00",
    "profile": [
      "https://fhir.doh.gov.ph/pheref/StructureDefinition/ereferral-patient"
    ]
  },
  ...
  "identifier": [
    {
      ...
      "value": "BT-PRACT-20260617-181457"
    }
  ],
  "name": [
    {
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2026-06-17T10:15:05.090+00:00",
    "profile": [
      "https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-practitioner"
    ]
  },
...
- **[PASS]** Practitioner created (HTTP 201) -> `16433`
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2026-06-17T10:15:05.373+00:00",
    "profile": [
      "https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-practitioner"
    ]
  },
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2026-06-17T10:15:05.593+00:00",
    "profile": [
      "https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-organization"
    ]
  },
...
- **[PASS]** Organization created (HTTP 201) -> `16435`
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2026-06-17T10:15:05.784+00:00",
    "profile": [
      "https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-organization"
    ]
  },
...
```json
{
  ...
  "entry": [
    {
      "fullUrl": "urn:uuid:nomatch-patient-20260617-181457",
      "resource": {
        "resourceType": "Patient",
        "meta": {
          "profile": [
    ...
    {
      "fullUrl": "urn:uuid:nomatch-obs-1-20260617-181457",
      "resource": {
        "resourceType": "Observation",
        "meta": {
          "profile": [
        ...
        "subject": {
          "reference": "urn:uuid:nomatch-patient-20260617-181457"
        },
        "effectiveDateTime": "2026-06-17T10:00:00+08:00",
        "component": [
          {
    ...
    {
      "fullUrl": "urn:uuid:nomatch-obs-2-20260617-181457",
      "resource": {
        "resourceType": "Observation",
        "meta": {
          "profile": [
...
{
  "resourceType": "Bundle",
  "id": "183b8666-10ce-482e-8582-1aa05acc1b2b",
  "type": "transaction-response",
  "link": [
    {
      "relation": "self",
  ...
  "entry": [
    {
      "response": {
        "status": "201 Created",
        "location": "Patient/16437/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:06.056+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Patient/16437/_history/1&quot;. Took 35ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Patient/16437/_history/1\". Took 35ms."
            }
          ]
        }
      }
    },
    {
      "response": {
        "status": "201 Created",
        "location": "Observation/16438/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:06.056+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Observation/16438/_history/1&quot;. Took 2ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Observation/16438/_history/1\". Took 2ms."
            }
          ]
        }
      }
    },
    {
      "response": {
        "status": "201 Created",
        "location": "Observation/16439/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:06.056+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Observation/16439/_history/1&quot;. Took 1ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Observation/16439/_history/1\". Took 1ms."
            }
          ]
        }
      }
...
```json
{
  ...
  "entry": [
    {
      "fullUrl": "urn:uuid:allvalid-patient-20260617-181457",
      "resource": {
        "resourceType": "Patient",
        "meta": {
          "profile": [
        ...
        "identifier": [
          {
            "system": "https://fhir.doh.gov.ph/identifier/philhealth-id",
            "value": "ALLVALID-20260617-181457"
          }
        ],
        "name": [
          {
    ...
    {
      "fullUrl": "urn:uuid:allvalid-obs-1-20260617-181457",
      "resource": {
        "resourceType": "Observation",
        "meta": {
          "profile": [
        ...
        "subject": {
          "reference": "urn:uuid:allvalid-patient-20260617-181457"
        },
        "effectiveDateTime": "2026-06-17T10:00:00+08:00",
        "component": [
          {
    ...
    {
      "fullUrl": "urn:uuid:allvalid-obs-2-20260617-181457",
      "resource": {
        "resourceType": "Observation",
        "meta": {
          "profile": [
...
{
  "resourceType": "Bundle",
  "id": "2099956a-6ca5-4161-97f9-a853704b0543",
  "type": "transaction-response",
  "link": [
    {
      "relation": "self",
  ...
  "entry": [
    {
      "response": {
        "status": "201 Created",
        "location": "Patient/16440/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:06.451+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Patient/16440/_history/1&quot;. Took 23ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Patient/16440/_history/1\". Took 23ms."
            }
          ]
        }
      }
    },
    {
      "response": {
        "status": "201 Created",
        "location": "Observation/16441/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:06.451+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Observation/16441/_history/1&quot;. Took 2ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Observation/16441/_history/1\". Took 2ms."
            }
          ]
        }
      }
    },
    {
      "response": {
        "status": "201 Created",
        "location": "Observation/16442/_history/1",
        "etag": "1",
        "lastModified": "2026-06-17T10:15:06.451+00:00",
        "outcome": {
          "resourceType": "OperationOutcome",
          "text": {
            "status": "generated",
            "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h1>Operation Outcome</h1><table border=\"0\"><tr><td style=\"font-weight: bold;\">INFORMATION</td><td>[]</td><td>Successfully created resource &quot;Observation/16442/_history/1&quot;. Took 1ms.</td></tr></table></div>"
          },
          "issue": [
            {
              "severity": "information",
              ...
              "diagnostics": "Successfully created resource \"Observation/16442/_history/1\". Took 1ms."
            }
          ]
        }
      }
...
- **[FAIL]** Transaction response includes '200 OK' for updated Patient statuses=[('201 Created', 'Patient/16429/_history/1'), ('201 Created', 'Observation/16430/_history/1'), ('201 Created', 'Observation/16431/_history/1')]
- **[PASS]** Transaction response includes '201 Created' for new Observations statuses=[('201 Created', 'Patient/16429/_history/1'), ('201 Created', 'Observation/16430/_history/1'), ('201 Created', 'Observation/16431/_history/1')]
---
...
```json
{
  ...
  "identifier": [
    {
      "system": "https://fhir.doh.gov.ph/identifier/prc-license",
      "value": "UNIQUE-NOMATCH-20260617-181457"
    }
  ],
  "name": [
    {
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2026-06-17T10:15:06.729+00:00",
    "profile": [
      "https://fhir.doh.gov.ph/phcore/StructureDefinition/ph-core-practitioner"
    ]
  },
...
Generated by `tests/run-bundle-test.py` on 2026-06-17T18:15:06.755946
